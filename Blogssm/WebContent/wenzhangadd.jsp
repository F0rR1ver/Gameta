                ...
                <div class="banner-text"> 
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">文章新增</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="login-section pt-100 pb-180"style="background-image:url(movies/界面/3.jpg);margin-top: -10px;">
            <div class="container">
                <div class="register-form box-content"style="background-color:#FCED0A;">
                    <h3 class="title">文章新增</h3>
                    <form action="wenzhangAdd.do" method="post">
                    
                    <div class="form-group">
                            <input type="text" class=" form-control" id="url" name="filename" placeholder="点击按钮上传图片" required />
                        ...
                        <select name="typeid" class=" form-control" required>
                         ...
                         <div class="form-group">
                          <textarea rows="" id="editor_id" name="content" style="width: 500px;height: 300px;" cols=""></textarea>
