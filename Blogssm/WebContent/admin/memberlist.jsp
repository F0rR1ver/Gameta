                            ...
                            <div class="c_content">
                                ...
                                <div class="margin-bottom-20">
                                    ...
                                    <div class="input-group" style="margin-left: 500px;">
                                      <input type="text" class="form-control" style="width: 200px;" name="key" value="${key }" placeholder="请输入姓名...">
                                  ...
                                  <table class="table table-hover dataTable table table-striped table-bordered" >
                                    ...
                                    <c:forEach items="${pageInfo.list }" var="member">
                                      ...
                                      <tr align="center">
                                        ...
                                        <td >
                                         <a href="memberDel.do?id=${member.id }"  title="删除" ><i class="fa fa-trash"></i></a>
                                        </td>
                                      </tr>
                                        </c:forEach>
                                        ...
                                        <tr>
                                            <td colspan="8">
                                                ...
                                                <div id="pagediv" style="border:0px solid red;">
                                                    <ul>
                                                        <li><a href="memberlist.do?pageNum=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a></li>
                                                        <c:forEach begin="1" end="${pageInfo.pages}" varStatus="status">
                                                            <li class="pagesz ${status.count eq pageInfo.pageNum ?"acvtive":""}" ><a href="memberlist.do?pageNum=${status.count}" >${status.count}</a></li>
                                                        </c:forEach>
                                                        <li><a href="memberlist.do?pageNum=${pageInfo.hasNextPage==false? pageInfo.pages : pageInfo.nextPage}">下一页</a></li>
                                                    </ul>
                                                </div>
                                                </c:if>
                                            </td>
