                        ...
                        <div class="c_panel">
                            ...
                            <div class="c_content">
                                ...
                                <div class="margin-bottom-20">
                                    <div class="btn-group">
                                     <a class="btn btn-success" href="javascript:void(0)" onclick="add('imgadd.jsp');">添加信息</a>
                                   <!-- <div class="input-group" style="margin-left: 500px;">
                                      <input type="text" class="form-control" style="width: 200px;" placeholder="请输入...">
                                  ...
                                  <table class="table table-hover dataTable table table-striped table-bordered" >
                                    ...
                                    <c:forEach items="${pageInfo.list }" var="img">
                                      ...
                                      <tr align="center">
                                        <td><img src="<%=path %>/upload/${img.filename}" style="width: 500px;height: 200px;"/></td>
                                        <td >
                                        <!-- <a href="#" class="edit btn btn-sm btn-default btn-raised rippler rippler-inverse" title="编辑"><i class="fa fa-pencil-square-o"></i></a> --> 
                                         <a href="imgDel.do?id=${img.id }" class="delete btn btn-sm btn-danger btn-raised rippler rippler-inverse" title="删除" style="margin-top: 90px;"><i class="fa fa-trash"></i></a>
                                        </td>
                                      </tr>
                                        </c:forEach>
                                        ...
                                        <tr>
                                            <td colspan="8">
                                                ...
                                                <div id="pagediv" style="border:0px solid red;">
                                                    <ul>
                                                        <li><a href="imglist.do?pageNum=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a></li>
                                                        <c:forEach begin="1" end="${pageInfo.pages}" varStatus="status">
                                                            <li class="pagesz ${status.count eq pageInfo.pageNum ?"acvtive":""}" ><a href="imglist.do?pageNum=${status.count}" >${status.count}</a></li>
                                                        </c:forEach>
                                                        <li><a href="imglist.do?pageNum=${pageInfo.hasNextPage==false? pageInfo.pages : pageInfo.nextPage}">下一页</a></li>
                                                    </ul>
                                                </div>
                                                </c:if>
                                            </td>
