                    ...
                    <div class="col-md-12">
                        <div class="c_panel">
                            ...
                            <div class="c_content">
                                ...
                                <form class="validator form-horizontal " id="signupForm" method="post" action="typeAdd.do">
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">名称:</label>
                                        <div class="col-lg-6">
                                            <input type="text" class=" form-control input-rounded" id="name" name="name" placeholder="名称" required  />
